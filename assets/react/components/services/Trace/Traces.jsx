...
function TraceNodeHeader( props ) {
	...
	return (
		<HStack className="flex-wrap" gap={2}>
			...
			{ disabled && <OverlayToggle overlay={ isString( disabled ) ? disabled : t("Disabled") }><Icon icon={ 'trace-disabled' } /></OverlayToggle> }
			{ skipped && <OverlayToggle overlay={ isString( skipped ) ? skipped : t("Skipped") }><Icon variant={ variant } icon={ 'trace-skipped' } /></OverlayToggle> }
