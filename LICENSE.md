...
**1.3 Internal Application Use:**  
Use of the Software as an internal component of a larger application
or service, including applications provided to the Licensee’s own
customers or end users, where the Software itself is not exposed,
marketed, or made available as a standalone product, platform, or
service.

**1.4 Commercial Self-Hosted Use:**  
...
**2.2 Commercial Self-Hosted Use:**  
...
Internal Application Use does not constitute SaaS or Cloud-Based Use,
provided that the Software itself is not exposed or offered as a
standalone service.
