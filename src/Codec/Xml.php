	...
	public function getCodecFields( $defaults = [] ): FieldCollection
	{
		return new FieldCollection( [
			'version'              => [
				...
				'help'        => $this->trans( 'Sets the XML version attribute' ),
				'type'        => 'text',
				'placeholder' => '1.0',
			...
			'encoding'             => [
				...
				'help'        => $this->trans( 'Sets the XML encoding attribute' ),
				'type'        => 'text',
				'placeholder' => 'utf-8',
				'default'     => $defaults['encoding'] ?? null,
			],
			'root_node_name'       => [
				'label'       => $this->trans( 'Root node' ),
				'help'        => $this->trans( 'Sets the root node name' ),
				'placeholder' => 'response',
				'type'        => 'text',
				'default'     => $defaults['root_node_name'] ?? null,
			],
			'format_output'        => [
				'label'      => $this->trans( 'Format output' ),
				'help'       => $this->trans( 'If set to true, formats the generated XML with line breaks and indentation' ),
				'type'       => 'checkbox',
				'default'    => $defaults['format_output'] ?? null,
				'_direction' => 'encode',
			],
			'standalone'           => [
				'label'      => $this->trans( 'Standalone' ),
				'help'       => $this->trans( 'Adds standalone attribute in the generated XML' ),
				'type'       => 'checkbox',
			...
			'remove_empty_tags'    => [
				'label'      => $this->trans( 'Remove empty tags' ),
				'help'       => $this->trans( 'Remove all empty tags in the generated XML' ),
				'type'       => 'checkbox',
				'default'    => $defaults['remove_empty_tags'] ?? null,
				'_direction' => 'encode',
			],
			'type_cast_attributes' => [
				'label'      => $this->trans( 'Type-cast attributes' ),
				'help'       => $this->trans( 'This provides the ability to forget the attribute type casting' ),
				'type'       => 'checkbox',
