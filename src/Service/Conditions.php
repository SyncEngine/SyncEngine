...
class Conditions
{
	...
	public function getOperator( string $operator ): string
	{
		return match ( $operator ) {
			...
			'not', 'not_in', 'nin', 'not_contains' => self::OPERATOR_NOT_IN,
			'ins', 'in_strict', 'contains_strict' => self::OPERATOR_IN_STRICT,
			'nins', 'not_in_strict', 'not_contains_strict' => self::OPERATOR_NOT_IN_STRICT,
