...
class Conditions
{
	...
	public static function isInputValue( mixed $value ): bool
	{
		return ! empty( $value ) || '0' === (string) $value;
	}

	public static function isKeyType( mixed $value ): bool
	{
